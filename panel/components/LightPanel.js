        ...
        <View style={styles.iconContainer}>
          <Svg width="60" height="60" viewBox="0 0 60 60">
            <Circle
              ...
              r="28"
              fill="none"
              stroke={status ? '#FFD700' : '#D4A574'}
              strokeWidth="2"
            />
            {/* Light bulb */}
            <Circle cx="30" cy="22" r="8" fill={status ? '#FFD700' : '#D4A574'} />
            <Path
              ...
              strokeWidth="1.5"
            />
            <Path d="M 28 38 L 28 41 M 32 38 L 32 41" stroke={status ? '#FFD700' : '#D4A574'} strokeWidth="1.5" />
          </Svg>
        </View>
